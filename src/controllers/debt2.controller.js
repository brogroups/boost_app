...
exports.getDebt2s = async (req, res) => {
    try {
        ...
        const debt2s = await Debt2Model.find({}).populate("debtId sellerId")
...
exports.getDebt2ById = async (req, res) => {
    try {
        const debt2 = await Debt2Model.findById(req.params.id).populate("debtId sellerId")
        if (!debt2) {
...
exports.updateDebt2ById = async (req, res) => {
    try {
        const debt2 = await Debt2Model.findByIdAndUpdate(req.params.id, { ...req.body, updateAt: new Date() }, { new: true }).populate("debtId")
        if (!debt2) {
            return res.status(404).json({
                success: false,
                message: "debt2 is not found"

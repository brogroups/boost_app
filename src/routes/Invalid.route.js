...
const { CreateReturnProSchema, UpdateReturnedProSchema } = require("../validations/InvalidPro.validation")


router.post("/InvalidPro", Middleware.verifyToken(process.env.JWT_TOKEN_ACCESS), Middleware.isCorrectRole([SuperAdminModel, ManagerModel, DeliveryModel]), Middleware.verifyValidation(CreateReturnProSchema), Controller.create)
...
router.put("/InvalidPro/:id", Middleware.verifyToken(process.env.JWT_TOKEN_ACCESS), Middleware.isCorrectRole([SuperAdminModel, ManagerModel]), Middleware.verifyValidation(UpdateReturnedProSchema), Controller.update)
